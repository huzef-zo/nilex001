      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 h-[100dvh] w-full overflow-y-auto bg-nilex-navy-deep/98 backdrop-blur-2xl md:hidden"
          >
            <div className="flex min-h-full flex-col justify-between px-6 pb-10 pt-24 sm:px-8">
              ...
              <motion.div
                ...
                className="mt-8 space-y-2 border-t border-white/10 pt-6 text-xs sm:text-sm text-white/60"
              >
